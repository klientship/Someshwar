        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-12 col-sm-12">
                    <p>Vista' includes 5 blocks of delightfully designed residential apartments with 1BHK, 2 BHK and 3 BHK spanning 
                        around 2.6 acre specious land.The property offers specifications such as club house/community centre, intercom facility, 
                        park, lift(S), visitor parking, water storage, security/fire alarm, piped-Gas ,Generator Backup.
                        Location Advantages : Bus Stop 150 M M ,Railway Station 5 Km ,School 1 KM , Hospital 3 km, Temple 500 M, Church 1 km , Mosque 2 Km .
                        Completion : The first phase, A and B block is expected to complete by May 2021.
                        Someshwar vista is a perfect home that has all the upmarket features and is well within the reach with affordable price tag. So indulge
                         in Nature and surround yourself with greenery, positivity and good health all this and more at an unbelievable price.</p>
                </div>
